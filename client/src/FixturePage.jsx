...
export default function FixturePage({ active, role }) {
  ...
  const [activeTab, setActiveTab] = useState("inventory"); // inventory | loans | overdue
                  ...
                  return (
                    <tr key={loan.id}>
                      ...
                      <td style={tdStyle}>
                        <Badge
                          status={
                            loan.status === "reserved" ? "loaned" : "loaned"
                          }
                        />
                      </td>
                      {canOperate && (
...
function OverdueList({ canOperate, onReturn, onRefresh }) {
