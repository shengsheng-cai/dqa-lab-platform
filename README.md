...
本專案將測試流程數位化，把 4 大國際標準的 65 個測試條件直接內建進系統，操作人員透過三步驟選擇法規、版本、測試條件後，參數自動帶入，無需手動比對文件。搭配物理模擬引擎，在硬體不在場時也能完整執行開發與驗證流程，降低人力成本與培訓門檻。
...
- **三步驟法規選擇** — 法規 → 版本/Class → 測試條件，4 大法規、65 個官方測試條件，各設備選擇獨立儲存
...
| **IEC 61850-3** | Ed.2:2013 / Ed.1:2002 | 13 | Class C1/C2/C3 各自乾熱+冷測+濕熱+高溫高濕穩態 Cab |
