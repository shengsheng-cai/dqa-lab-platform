...
- **儀表板** — 即時溫濕度監控（每秒更新）、趨勢圖（每分鐘一點，最近 60 分鐘）、步驟進度條、六種狀態顏色區分
- **三步驟法規選擇** — 法規 → 版本/Class → 測試條件，6 大法規、62 個官方測試條件，動態載入
- **SOP 步驟依序確認** — 步驟必須依序勾選，取消時連鎖清除後續，Optional 步驟可跳過，符合實際操作流程
...
- **ISO 17025 測試報告** — 7 節格式，big5 編碼 Excel 相容，PASS/FAIL 由授權工程師人工判定
