...
| | |
|---|---|
| **149 automated tests** | Device state machine · Schedule calculation · Fixture lifecycle · Three-module integration · SOP validation · Measurement uncertainty · Calibration & maintenance CRUD · Frontend utility (Vitest) |
...
| **品質** | pytest 138 tests · Vitest 11 tests · GitHub Actions CI/CD · Alembic 版本控制遷移 |
